...
// Template for a new view-ui implementation

class ViewUITemplate : public ViewUI {
public:
	// Constructor
	ViewUITemplate(PicHandler& picHandler, SpiHandler& spiHandler) : ViewUI(picHandler, spiHandler) {}
