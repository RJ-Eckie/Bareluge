#include "hardware_test_ui.h"

namespace bareluge {

// Called when ui is created
void HardwareTestUI::init() {
...
void HardwareTestUI::handleButtonPress(uint8_t index, bool pressed) {
...
void HardwareTestUI::handleEncoderPress(uint8_t index, bool pressed) {
...
void HardwareTestUI::handleEncoderRotation(uint8_t index, bool clockwise) {
...
void HardwareTestUI::handleMainGridPress(uint8_t x, uint8_t y, bool pressed) {
...
void HardwareTestUI::handleSidebarPress(bool isRightColumn, uint8_t y, bool pressed) {
