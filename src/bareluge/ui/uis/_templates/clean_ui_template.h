...
// Clean template for a new ui implementation

class CleanUITemplate : public UI {
public:
	// Constructor
	CleanUITemplate(PicHandler& picHandler, SpiHandler& spiHandler) : UI(picHandler, spiHandler) {}
